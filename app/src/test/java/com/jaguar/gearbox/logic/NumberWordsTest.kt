...
class NumberWordsTest {
    ...
    fun `long max value does not throw and covers all scale words`() {
        ...
        assertEquals("Nine Quintillion Two Hundred Twenty-Three Quadrillion " +
                "Three Hundred Seventy-Two Trillion Thirty-Six Billion Eight Hundred " +
                "Fifty-Four Million Seven Hundred Seventy-Five Thousand Eight Hundred Seven", words)
    }
    ...
    fun `indian system groups by lakh and crore instead of million and billion`() {
        assertEquals("One Crore Twenty-Three Lakh Forty-Five Thousand", numberToWordsIndian(12345000L))
